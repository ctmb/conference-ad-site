...
export default class extends React.Component {
    ...
    render() {
        ...
        <section className = "tourInfo">
            <Carousel>
                <Carousel.Item>
                    <img className="carousel-pic" width={900} height={500} alt="900x500" src="./castlepics/master1.jpg"/>
                    <Carousel.Caption>
                    ...
                    <Carousel.Item>
                    <img className="carousel-pic" width={900} height={500} alt="900x500" src="./castlepics/master2.jpg"/>
                    <Carousel.Caption>
                    ...
                    <Carousel.Item>
                    <img className="carousel-pic" width={900} height={500} alt="900x500" src="./castlepics/master3.jpg"/>
                    <Carousel.Caption>
            ...
            <div className = "description">
                <div className = "packheader">
                    <h2>Master bedroom <small> Can room 4 or more guests </small></h2>
