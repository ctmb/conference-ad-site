...
export default class extends React.Component {
    ...
    render() {
        ...
        <section className = "tourInfo">
            <Carousel>
                <Carousel.Item>
                    <img className="carousel-pic" width={900} height={500} alt="900x500" src="./castlepics/south1.jpg"/>
                    <Carousel.Caption>
                    ...
                    <Carousel.Item>
                    <img className="carousel-pic" width={900} height={500} alt="900x500" src="./castlepics/south2.jpg"/>
                    <Carousel.Caption>
                    ...
                    <Carousel.Item>
                    <img className="carousel-pic" width={900} height={500} alt="900x500" src="./castlepics/south3.jpg"/>
                    <Carousel.Caption>
            ...
            <div className = "description">
                <div className = "packheader">
                    <h2>South Loft <small> Mirrors the North with several beds </small></h2>
