...
export default class extends React.Component {
    ...
    render() {
        ...
        <section className = "tourInfo">
            <Carousel>
                <Carousel.Item>
                    <img className="carousel-pic" width={900} height={500} alt="900x500" src="./castlepics/study1.jpg"/>
                    <Carousel.Caption>
                    ...
                    <Carousel.Item>
                    <img className="carousel-pic" width={900} height={500} alt="900x500" src="./castlepics/study2.jpg"/>
                    <Carousel.Caption>
                    ...
                    <Carousel.Item>
                    <img className="carousel-pic" width={900} height={500} alt="900x500" src="./castlepics/study3.jpg"/>
                    <Carousel.Caption>
            ...
            <div className = "description">
                <div className = "packheader">
                    <h2>Study <small>Open room with breath taking views</small></h2>
