...
export default class extends React.Component {
    ...
    render() {
        ...
        <section className = "tourInfo">
            <Carousel>
                <Carousel.Item>
                    <img className="carousel-pic" width={900} height={500} alt="900x500" src="./castlepics/foyer1.jpg"/>
                    <Carousel.Caption>
                    ...
                    <Carousel.Item>
                    <img className="carousel-pic" width={900} height={500} alt="900x500" src="./castlepics/foyer4.jpg"/>
                    <Carousel.Caption>
                    ...
                    <Carousel.Item>
                    <img className="carousel-pic" width={900} height={500} alt="900x500" src="./castlepics/foyer7.jpg"/>
                    <Carousel.Caption>
            ...
            <div className = "description">
                <div className = "packheader">
                    <h2>Main Entry Hall <small>Welcome to the Castle</small></h2>
