...
export default class extends React.Component {
    ...
    render() {
        ...
        <section className = "tourInfo">
            <Carousel>
                <Carousel.Item>
                    <img className="carousel-pic" width={900} height={500} alt="900x500" src="./castlepics/rock1.jpg"/>
                    <Carousel.Caption>
                    ...
                    <Carousel.Item>
                    <img className="carousel-pic" width={900} height={500} alt="900x500" src="./castlepics/rock2.jpg"/>
                    <Carousel.Caption>
                    ...
                    <Carousel.Item>
                    <img className="carousel-pic" width={900} height={500} alt="900x500" src="./castlepics/rock3.jpg"/>
                    <Carousel.Caption>
            ...
            <div className = "description">
                <div className = "packheader">
                    <h2>Rock room <small>Sleep like a king</small></h2>
